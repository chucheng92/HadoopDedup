...
import com.rannn.core.FSPFileInputFormat;
import com.rannn.pojo.ChunkInfo;
import com.rannn.util.Constant;
import com.rannn.util.HBaseUtil;
...
public class FSPChunkLevelDedup {
    ...
    private static class FSPMapper extends Mapper<IntWritable, ChunkInfo, Text, ChunkInfo> {
        ...
        protected void map(IntWritable key, ChunkInfo value, Context context) throws IOException, InterruptedException {
            ...
            HBaseUtil.put(Constant.DEFAULT_HBASE_TABLE_NAME, value.getFileName(), "fileFamily", "chunksQualifier", curValue);
