package com.rannn.security;

import com.rannn.util.LittleEndian;
import com.rannn.util.Parameters;
...
final class Keccak extends AbstractDigest {
    ...
    public static void main(String[] args) {
        byte[] bytes = "".getBytes();
        byte[] keccakByte = Digests.keccak224().digest(bytes);
        String keccakHash = StringUtils.bytesToHexString(keccakByte);
        System.out.println();
